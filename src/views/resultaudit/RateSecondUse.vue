        ...
        <el-form ref="form" label-width="100px" label-position="right">
            <el-row>
                <el-col :span="22">
                  ...
                  <el-col :span="2" v-if="!detail">
                    <el-button size="mini" type="primary" @click.prevent="save('usage2','conclusion',form.usage2.conclusion)">保存</el-button>
                </el-col>
            </el-row>
            <el-row>
                <el-input type="textarea" v-model="form.usage2.conclusion"></el-input>
            </el-row>
            <el-row>
            ...
            <el-row>
                <table class="table">
                    ...
                    <tr class="tr" v-for="o in form.usage2.index" :key="o.type">
                        <td class="td">
            ...
            <el-row>
                <el-input type="textarea" v-model="form.usage2.level"></el-input>
            </el-row>
            <el-row>
            ...
            <el-row>
               <el-col :span="22">
                <span class="text-sm">说明：</span>
                  ...
                  <el-col :span="2" v-if="!detail">
                    <el-button size="mini" type="primary" @click.prevent="save('usage2','uniformity',form.usage2.uniformity)">保存</el-button>
                </el-col>
            </el-row>
            <el-row>
                <el-input type="textarea" v-model="form.usage2.uniformity"></el-input>
            </el-row>
            <el-row>
                <el-col :span="21">
            ...
            <el-row>
                <el-col :span="16">
                     <NormalityChart id="second"  :width="width"></NormalityChart>
                </el-col>
                <el-col :span="8">
