...
<el-row :gutter="10" style="margin-left:20px;margin-right:20px;margin-top:10px;margin-bottom:10px;">
    <el-col :span="3">
      <el-select filterable  v-model="rwlx" placeholder="任务类型" clearable size="medium">
        <el-option
    ...
    <el-col :span="3">
      <el-select filterable  v-model="wczt" placeholder="完成状态" clearable size="medium">
        <el-option
          v-for="item in state"
          :key="item.value"
          :label="item.label"
    ...
    <el-col :span="3">
      <el-select filterable  v-model="yt" placeholder="房地产用途" clearable size="medium">
        <el-option
  ...
  <div class="tablePagination">
    <el-table :cell-class-name="getCellClass"
      ...
      <el-table-column
        ...
        width="200">
        <template slot-scope="scope">
          <router-link :to="{ name:'Resp' ,query: {}}">
            <el-button type="text" v-if="scope.row.wczt == 0" size="small">分配</el-button>
          </router-link>
