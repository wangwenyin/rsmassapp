...
export const constantRouterMap = [
...

  {
    ...
    },
    {
      ...
      children: [{
        ...
        name: 'import',
        component: () =>
                  import('@/views/datamanage/tools/imp'),
      ...
      },
      {
        ...
        name: 'export',
        component: () =>
                  import('@/views/datamanage/tools/exp'),
      ...
      },
      {
        ...
        name: 'massedit',
        component: () =>
                  import('@/views/datamanage/tools/massedit'),
  ...
  },
  {
    ...
    children: [{
      ...
      name: 'Rsstat',
      component: () =>
              import('@/views/statistic/rsstat.vue'),
    ...
    },
    {
      ...
      name: 'Casestat',
      component: () =>
              import('@/views/statistic/casestat.vue'),
    ...
    },
    {
      ...
      name: 'Appealstat',
      component: () =>
              import('@/views/statistic/appealstat.vue'),
