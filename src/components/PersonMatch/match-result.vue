    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <span v-if="scope.row.wczt == 0" style="color:red">退回</span>
          <span v-if="scope.row.wczt == 1" style="color:green">完成</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="yjwcsj"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-popover 
            placement="right"
            trigger="click">
            <div class="map" style="width:720px;">
              <coordinate :center="center"></coordinate>
            </div>
            <el-button type="text" size="small" slot="reference">位置</el-button>
          </el-popover>
        </template>
      </el-table-column>
    </el-table>
